...
jpeg("omega_cladewise_repeats_nonrepeats_comparison_speciesspecific.jpeg",width=28,height=18,units="in",res=300)
par(mar=c(5,4,4,1))
myplot <- boxplot(omega ~ status*new_order, data=data,ylim=c(-0.75,2), 
        ...
        xaxt="n")
title(main="Omega variation in proteins with repeats and proteins without repeats" ,line=1,cex.main=2.3)
